...
function GridView() {
  const { data, currentPage, onsetPage, total } = useContext(DataContext);
  let items = data;
...
// const Gridviewv2 = ({data}) =>{
//   const {  currentPage, onsetPage, total } = useContext(DataContext);
//   let items = data;
//   const sixItems = items.slice(0, 6);
//   const otherItems = items.slice(6);
...
// export const GridViewV2 = React.memo(Gridviewv2)
